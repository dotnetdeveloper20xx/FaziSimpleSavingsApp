...
namespace FaziSimpleSavings.Infrastructure.Migrations
{
    ...
    [Migration("20250730161038_AddGroupTransactionEntity")]
    partial class AddGroupTransactionEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FaziSimpleSavings.Core.Entities.GroupGoalMember", b =>
                {
                    ...
                    b.ToTable("GroupGoalMembers");
                });

            modelBuilder.Entity("FaziSimpleSavings.Core.Entities.GroupSavingsGoal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
